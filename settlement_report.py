...
AUCTION_BLOCKS = [
    ...
    ("14", None, frozenset({"도라지", "더덕", "마"}), "00:20 (서병수, 김선우) 부장"),  # 도라지·더덕·마 제외 → 오준서(태은이 2026-07-20)
    ...
    # 태은이 2026-07-20: 수입 곶감·호두 → 안대명·심세영 (수입 품종/원산지 분리, 국산 곶감=김상걸·차수호·국산 호두=미배정 유지). _reclassify가 '수입곶감'·'수입호두'로 재라벨.
