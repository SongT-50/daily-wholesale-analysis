...
AUCTION_BLOCKS = [
    ...
    ("06", frozenset({"듀리안", "레몬", "망고", "망고스턴", "바나나", "아로니아",
                      ...
                      "코코넛", "파인애플"}), None, "(안대명, 심세영) 부장 (수입과일·수입땅콩)"),
    ...
    ("06", frozenset({"수입곶감"}), None, "(안대명, 심세영) 부장 (수입과일·수입땅콩)"),
    ("07", frozenset({"수입호두"}), None, "(안대명, 심세영) 부장 (수입과일·수입땅콩)"),
    # 태은이 2026-07-21: 수입 포도·블루베리·멜론 → 안대명·심세영. 국산은 원래대로
    #   (포도=김상걸·차수호 / 블루베리·멜론=이기송). _reclassify가 '수입포도'·'수입블루베리'·'수입멜론'으로 재라벨.
    ("06", frozenset({"수입포도", "수입블루베리"}), None, "(안대명, 심세영) 부장 (수입과일·수입땅콩)"),
    ("08", frozenset({"수입멜론"}), None, "(안대명, 심세영) 부장 (수입과일·수입땅콩)"),
